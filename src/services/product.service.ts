...
export class ProductService {
    ...
    public async updateProduct( userId: string, id: string, updateProductDto: UpdateProductDto ) {
        ...
        const productExist = ( userExist.role === 'admin')
        ...
        try {
            ...
            if (updateProductDto.price) productExist.price = updateProductDto.price;
            if (updateProductDto.image !== '') productExist.image = updateProductDto.image;
            if (updateProductDto.duration_minutes !== 0) productExist.duration_minutes = updateProductDto.duration_minutes;
            if (updateProductDto.active) productExist.active = updateProductDto.active;
